  ...
  return (
    <section className="main sign-on">
        <form onSubmit={handleLogin} autoComplete="off">
          ...
          <label htmlFor="email" className="sans-serif white subpara">
            Email:
          </label>
          <input
            id="email"
            name="email"
            type="email"
            className="sans-serif sm"
            onChange={handleChange}
          />

          <label htmlFor="password" className="sans-serif white subpara">
            Password:
          </label>
          <input
            id="password"
          ...
          <button type="submit" className="sans-serif sm">
            Submit
          </button>
          {errorMessage && <div className="serif sm gold">Login failed.</div>}
        </form>
    </section>
  );
};
